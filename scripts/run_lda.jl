...
# This script runs DFT-LDA (LSDA) calculations for a Carbon atom
# with different basis sets for the GROUND STATE (triplet, ³P).

println("="^70)
println("Carbon Atom Ground State (³P, N_up=4, N_down=2)")
println("DFT with Local Spin Density Approximation (LSDA)")
println("="^70)
...
println("\n| Basis Set | LSDA Energy (Hartree) | Status |")
println("|:----------|:----------------------|:-------|")
